...
const TodoCard = ({ id, title, description, isCompleted = false }: TTodoCard) => {
  ...
  return (
      ...
      <div className="bg-white rounded-md flex flex-col  md:flex-row justify-between p-3 border space-y-4 md:space-y-0">
        ...
        <div>
        <p className="text-sm md:text-base">{isChecked ? <span className="text-green-700 font-semibold">Done</span> : <span className="text-red-700">Pending</span>}</p>
        </div>
        </div>
